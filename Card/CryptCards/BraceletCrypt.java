...
public class BraceletCrypt extends CryptCards{
   
   public BraceletCrypt(){
      super(30);
      active = true;
   }
   ...
   public void mainAction(){
      ...
      Display.showTextPopup("You received 120 gold\nyou have a total of "+ (HVMPanel.players.get(HVMPanel.currentPlayer).gold()+120));
   }
}